        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Sign up to get started with NanoFi
            </p>
          </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="form-label form-label-required">Password</FormLabel>
                      <FormControl>
                        <div className="relative">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="form-label form-label-required">Confirm Password</FormLabel>
                      <FormControl>
                        <div className="relative">
                          <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                          <Input
                ...
                <div className="flex items-start space-x-2">
                  <input
                    ...
                    id="terms"
                    required
                    className="w-4 h-4 mt-0.5 rounded border-border text-primary focus:ring-primary focus:ring-2"
                  />
                  <label
                    htmlFor="terms"
